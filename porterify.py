...
parser.add_argument(
    "input", type=str, metavar="input image", help="The image to stamp."
)
parser.add_argument(
    "output", type=str, metavar="output image", help="The stamped image."
)
parser.add_argument(
    "--number",
    "-n",
    type=int,
    metavar="number of stamps",
    default=5,
    help="The number of stamps to put on the image.",
)
parser.add_argument(
    "--porter",
    "-p",
    type=str,
    metavar="porter image",
    default="porter.webp",
    help="The image to stamp. Default: porter.webp",
)
parser.add_argument(
    "--scale",
    "-s",
    ...
    metavar="scale",
    default=1.0,
    help="The scale of the stamp. Default: 1.0",
)
parser.add_argument(
    "--even", "-e", action="store_true", help="Make the distribution of stamps even."
)
